...
(function () {
  ...
  function render(params, root) {
    ...
    root.innerHTML =
      ...
      '    <div style="text-align:center;margin-top:16px"><a class="btn btn--outline btn--sm" href="#/plan-detalle/proveedor">' + u.icon('list', { size: 14 }) + ' Ver todo lo que incluye el plan, a detalle</a></div>' +
      '  </div>' +
