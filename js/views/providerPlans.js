...
(function () {
  ...
  function render(params, root) {
    ...
    root.innerHTML =
      ...
      '    <a class="btn btn--outline btn--block" style="margin-top:18px;font-weight:800" href="#/plan-detalle/proveedor">' + u.icon('list', { size: 16 }) + ' Ver todo lo que incluye el plan, a detalle</a>' +
      '  </div>' +
