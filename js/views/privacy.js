...
(function () {
  ...
  function render(params, root) {
    var content =
      ...
      '<li><strong>Proveedores del directorio de servicios:</strong> nombre o razón social, correo, teléfono/WhatsApp, ciudad, categoría de servicio, descripción del negocio, fotografías y ubicación exacta en el mapa (si la compartes).</li>' +
