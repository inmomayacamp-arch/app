...
(function () {
  ...
  function render(params, root) {
    ...
    root.innerHTML =
      ...
      '      </ul>' +
      '      <a class="plan-summary__change plan-summary__change--anual" href="#/registro-agente/' + (billing === 'anual' ? 'mensual' : 'anual') + '">' + (billing === 'anual' ? 'Cambiar a mensual' : 'Cambiar a anual') + '</a>' +
      '    </div>' +
